...
display(dbutils.fs.ls(single_product_csv_file_path))
...
# TODO
products_output_path = f"{DA.paths.working_dir}/delta/products/_delta_log/user.parquet"
# products_df.write.option("header",True).parquet(products_output_path)
